...
public class Restaurant {
    ...
    public static String jsonArrayToString(JSONArray array) {	// for full address JSON to string
   	 ...
   	 try {
   		 for (int i = 0; i < array.length(); i++) {
   			 ...
   			 sb.append(obj);
   			 if (i != array.length() - 1) {
   				 sb.append(",");	// xxx street, city, state
   			 }
   		 }
   		 ...
   		 if (object != null) {
   			 ...
   			 for (int i = 0; i < jsonArray.length(); i++) {
   				 ...
   				 for (int j = 0; j < subArray.length(); j++) {
   					 // "abc\"def" -> "abc\\\"def" and "abc/def" -> "abc or def"
   					 // change the format so that java can read the string
   		   			 //System.out.println("before parse: " + subArray.getString(j));
   		   			 //System.out.println("after parse: " + parseString(subArray.getString(j)));
   					 list.add(parseString(subArray.getString(j)));
   				 }
   			 }
   			 this.categories = String.join(",", list);	// chinese,japanese,...
    ...
    public Restaurant(String businessId, String name, String categories,
    		String city, String state, String fullAddress, double stars,
    ...
    public JSONObject toJSONObject() {
   	 ...
   	 try {
   		 ...
   		 obj.put("url", url);
   	   	 //System.out.println("raw categories: " + categories);
   	   	 //System.out.println("stringToJSONArray: " + stringToJSONArray(categories));
   	   	 //System.out.println("obj.get: " + obj.get("categories"));
   	 } catch (JSONException e) {
   		 e.printStackTrace();
   	 }
   	 return obj;
